...
<form method="POST" action="../controller/controller_login.php">
    <div class="col-md-4 col-sm-6 col-xs-12">
        <fieldset>
            ...
            <p id="unameErr"></p><?php echo $unameErr ?></span><br>
            <label for="password">Password</label>
            <input type="password" name="password" id="password" value="<?php ?>" onblur="passwordValidation()">
            <p id="passErr"></p><?php echo $passErr ?></span><br>
